	...
	<div class="panel-body">
		...
		<form class="form-horizontal form-validate-jquery" action="<?= $actionForm ?>" method="POST" enctype="multipart/form-data" name="pengaduan-form" id="pengaduan-form">
			<fieldset class="content-group">
				...
				<input type="hidden" name="Companyid" id="Companyid" class="form-control" placeholder="" title="" value="<?= isset($companyID) ? $companyID : '' ?>" readonly>
			...
			<div class="text-right">
				<button type="reset" onclick="location.href='<?=base_url('company/form/'.$companyID)?>'" class="btn btn-default" id="reset">Cancel <i class="icon-reload-alt position-right"></i></button>
