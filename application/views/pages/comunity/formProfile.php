	...
	<div class="panel-body">
		...
		<form class="form-horizontal form-validate-jquery" action="<?= $actionForm ?>" method="POST" name="pengaduan-form" id="pengaduan-form">
			<fieldset class="content-group">
				...
				<div class="collapse in" id="demo1">
					...
					<?php foreach ($dField as $key):
							...
							if ($name == 'typeComunity') {
								$btnConfig = '<a data-placement="left" data-popup="tooltip" title="Type Manage" style="color: blue;" target="_blank" href="'.base_url("type").'"><i class="icon-gear"></i></a>';
							}else{
								$btnConfig = '';
							}
			...
			<div class="text-right">
				<button type="reset" onclick="location.href='<?=base_url('comunity')?>'" class="btn btn-default" id="reset">Back <i class="icon-reload-alt position-right"></i></button>
