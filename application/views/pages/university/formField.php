<div class="panel panel-flat">
	...
	<div class="panel-body">
		<input type="hidden" name="getType" id="getType" value="<?= base_url('university/get_typedata') ?>">
		<input type="hidden" name="getField" id="getField" value="<?= base_url('university/get_field') ?>">
		<form class="form-horizontal form-validate-jquery" action="<?= $actionForm ?>" method="POST" enctype="multipart/form-data" name="pengaduan-form" id="pengaduan-form">
			<fieldset class="content-group">
				...
				<input type="hidden" name="Universityid" id="Universityid" class="form-control" value="<?= isset($universityID) ? $universityID : '' ?>" readonly>
			...
			<div class="text-right">
				<button type="reset" onclick="location.href='<?=base_url('university/form/'.$universityID)?>'" class="btn btn-default" id="reset">Cancel <i class="icon-reload-alt position-right"></i></button>
